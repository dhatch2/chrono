...
ChVector<> initLoc(-36.605637, 0, 1.6);
...
*/
  ...
  // Create the circle driver system

  ChPathFollowerDriver driver(my_hmmwv.GetVehicle(),
  "../data/vehicle/generic/driver/SteeringController.json",
  "../data/vehicle/generic/driver/SpeedController.json",
  ChBezierCurve::read("../data/vehicle/paths/circle.txt"),
  "circle", 20.0, true);

  std::cout << "read jsons" << std::endl;
